...
The `utils.ts` file contains some helper functions for interacting with the Ankr Advanced APIs.

The `hooks.ts` file contains some React hooks for those helper functions.
